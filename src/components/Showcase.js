...
import github from '../assets/images/github-main.png';
import notionPic1 from '../assets/images/notion-t1.jpg';
import notionPic2 from '../assets/images/notion-t2.jpg';
import notionPic3 from '../assets/images/notion-t3.jpg';
import notionPic4 from '../assets/images/notion-t4.jpg';
...
function Showcase() {
    ...
    return (
        <section className='pt-16 flex flex-col gap-5'>
            ...
            <div className='flex flex-row gap-5'>
                ...
                {/* Linkedin Box */}
                <div className='glow-border border-solid border-gray-300 dark:bg-g-2 border dark:border-g-1 rounded-2xl p-5 shadow-md w-[230px]' onMouseMove={handleMouseMove}>
