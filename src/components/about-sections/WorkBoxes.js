        ...
        <div className='mt-6 grid grid-rows-1'>
            ...
            <div className={`work-box flex flex-row justify-between ${hoveredIndex === null || hoveredIndex === 1 ? 'opacity-100' : 'opacity-50'}`} onMouseOver={() => handleMouseOver(1)} onMouseOut={handleMouseOut}>
                <div className='flex items-center w-14 h-14'>
                    <a href='https://www.dal.ca/' target="_blank" rel="noreferrer"><img src={dalLogo} alt='dalhousie logo' className='w-full h-full rounded-full transition-transform transform hover:scale-110'/></a>
                </div>

                <div className='flex flex-col justify-center sm:-ml-20 md:-ml-28'>
                    <div class='flex items-center'>
                        <p class='pr-1 text-xs sm:text-base'>Junior Student Developer</p>
