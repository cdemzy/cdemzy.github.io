...
function FlappySection() {
    ...
    return(
        <div class='flex flex-col md:flex-row subpixel-antialiased'>
            ...
            <Link class='glow-border-sm bg-w-2 dark:bg-g-5 border dark:border-g-1 box-shdw rounded-xl w-full md:w-[40%] md:h-[150px] mr-10' to='/projects/flappybird' onMouseMove={handleMouseMove}>
            ...
            <div class='info pt-4 md:pt-0 md:w-[60%]'>
                <div class='title flex flex-row'>
                    <h2 class='font-medium tracking-wide'>Flappy Bird (Clone)&nbsp;</h2>
